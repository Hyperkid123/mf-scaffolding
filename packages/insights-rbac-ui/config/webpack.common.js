...
const entry = process.env.NODE_ENV === 'production' ? path.resolve(__dirname, '../src/entry.js') : path.resolve(__dirname, '../src/entry-dev.js');
...
const betaBranch = gitBranch === 'master' || gitBranch === 'ci-beta' || gitBranch === 'qa-beta' || gitBranch === 'prod-beta';
